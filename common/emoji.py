# Original: https://github.com/jonathan-kosgei/emoji-flags
...
for flag in EMOJI_FLAGS:
    EMOJI_FLAG_MAP[flag["code"]] = flag["emoji"]


def emoji_flag_lookup(country_code):
    if country_code in EMOJI_FLAG_MAP:
        return EMOJI_FLAG_MAP[country_code]
    return None
